...
# Put them all together in a table
dplyr::bind_rows(
...
# tidy categorical function, creates variables and levels, references categories
model<-tidy(logistic_model, conf.int = TRUE, exponentiate = TRUE) |>
